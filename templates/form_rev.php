...
<section>
    <div class="container">
        <div id="more_info_content" class="box info flex">
            <form name="upload" action="/form_rev" method="POST" ENCTYPE="multipart/form-data">


                <div class="info_img info_box">
                    <?php
                    if (isset($_SESSION['dowland_img_rev']['status']) && $_SESSION['dowland_img_rev']['status'] == 0) {
            ...
            <div class="info_text info_box">
                ...
                <div class="help_code">
<!--                    <button onclick="scripts.js/rev_submit()" class="info_btn">Добавить</button>-->
                    <?php
                    if (isset($_SESSION['dowland_img_rev']['status']) && $_SESSION['dowland_img_rev']['status'] == 0) {
